...
public class Record {
    ...
    public void start() {
        int minBufferSize_in = AudioRecord.getMinBufferSize(mFrequence, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT);
        Log.d("BufferSize " , minBufferSize_in+"");
